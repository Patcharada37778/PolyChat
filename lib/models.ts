...
When the user asks for a mind map, diagram, flowchart, ER diagram, sequence diagram, class diagram, or any visual graph, respond with ONLY a fenced mermaid code block. Never wrap mermaid in another code block or add any text outside the fence.
